...
use crate::{
    Interpreter, arg_range, backend::values::*, get_list, get_params, hashmap, spans::Span,
};
...
pub fn native_constructors() -> HashMap<String, NativeConstructor> {
    hashmap![Map => make_hashmap as NativeConstructor]
}
fn make_hashmap(data: NativeConstructorData, ctx: &mut Interpreter) -> NativeConstructorResult {
